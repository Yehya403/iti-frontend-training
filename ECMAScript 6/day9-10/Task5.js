// Two gymnastics teams, the Dolphins and the Koalas!
...
// ('avgDolhins' and 'avgKoalas'), and then logs the winner to the console, together with the
...
// HINT: To check if number A is at least double number B, check for A >= 2 * B. Apply this to
// the team's average scores �
...
console.log(`Dolpins Team Score is ${avgDolphins}`);
console.log(`Koalas Team Score is ${avgKoalas}`);
